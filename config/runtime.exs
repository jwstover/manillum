...
#
#     PHX_SERVER=true bin/manillum start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :manillum, ManillumWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :manillum, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :manillum, Manillum.Mailer,
