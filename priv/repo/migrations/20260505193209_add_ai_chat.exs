defmodule Manillum.Repo.Migrations.AddAiChat do
  @moduledoc """
  ...
  def up do
    ...
    alter table(:conversations) do
      add :title, :text
      add :query_number, :bigint, null: false
    ...
    create unique_index(:conversations, [:user_id, :query_number],
             name: "conversations_unique_query_number_per_user_index"
           )
  end
  ...
  def down do
    ...
    drop_if_exists unique_index(:conversations, [:user_id, :query_number],
                     name: "conversations_unique_query_number_per_user_index"
                   )
